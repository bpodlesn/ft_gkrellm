...
/*   Updated: 2018/07/01 21:32:56 by vmazurok         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Audio::Audio(Audio const &cpy) {
	*this = cpy;
}

Audio &Audio::operator=(Audio const &cpy) {
	_man = cpy._man;
	_win = cpy._win;
	_audioSample = cpy._audioSample;
	_microSample = cpy._microSample;
	_height = cpy._height;
	_width = cpy._width;
	_mode = cpy._mode;
	this->font = cpy.font;
